  ...
  return (
    <div className="p-4 md:p-8 max-w-7xl mx-auto min-h-screen">
      ...
      <ConfirmOtpModal
        ...
        title="Remove Students Permanently"
        description={
          <>
            Enter the OTP sent to your admin email to permanently remove{" "}
            <span className="font-bold text-gray-700">{selectedIds.length}</span> student
            account{selectedIds.length > 1 ? "s" : ""}. This cannot be undone.
          </>
        }
